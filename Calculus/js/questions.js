...
<<<<<<< HEAD
      ...
      // Очень сложные интегралы
      const veryHardIntegralsQuestions = [
        {
          question: "Вычислите интеграл $\\int x^3 e^{x^2} dx$",
          options: [
            "$\\tfrac{1}{2} e^{x^2}(x^2 - 1) + C$",
            "$\\tfrac{1}{2} e^{x^2}(x^2 + 1) + C$",
            "$e^{x^2}(x^2 - 1) + C$",
            "$\\tfrac{1}{2} e^{x^2}(x^2 - \\tfrac{1}{2}) + C$",
          ],
          correct: 0,
        },
        {
          question: "Вычислите интеграл $\\int \\sin(\\ln x) dx$",
          options: [
            "$\\tfrac{x}{2}[\\sin(\\ln x) - \\cos(\\ln x)] + C$",
        ...
        {
          question: "Вычислите интеграл $\\int e^{2x} \\cos(3x) dx$",
          options: [
            "$\\tfrac{e^{2x}(2 \\cos(3x) + 3 \\sin(3x))}{13} + C$",
            "$\\tfrac{e^{2x}(2 \\cos(3x) - 3 \\sin(3x))}{13} + C$",
            "$\\tfrac{e^{2x}(3 \\cos(3x) + 2 \\sin(3x))}{13} + C$",
            "$\\tfrac{e^{2x}(3 \\cos(3x) - 2 \\sin(3x))}{13} + C$",
          ],
          correct: 0,
        },
        {
          question:
            "Вычислите интеграл $\\int \\frac{dx}{x^2 \\sqrt{x^2 - 1}}$",
          options: [
            "$\\frac{\\sqrt{x^2 - 1}}{x} + C$",
            "$-\\arccos(1/x) + C$",
            "$\\arcsin(1/x) + C$",
        ...
        {
          question: "Вычислите интеграл $\\int x^2 \\ln(x) dx$",
          options: [
            "$\\tfrac{x^3}{3} \\ln(x) - \\tfrac{x^3}{9} + C$",
            "$\\tfrac{x^3}{2} \\ln(x) - \\tfrac{x^3}{6} + C$",
        ...
        {
          question: "Вычислите интеграл $\\int \\frac{dx}{x^4 + 1}$",
          options: [
            "$\\tfrac{1}{2} \\arctan(x^2) + C$",
            "$\\tfrac{1}{\\sqrt{2}} \\arctan(1/x) + C$",
            "$\\tfrac{1}{2\\sqrt{2}} \\arctan \\left( \\tfrac{x^2 - 1}{x \\sqrt{2}} \\right) + C$",
            "$\\tfrac{1}{2} \\ln(x^2+1) + C$",
          ],
          correct: 2,
        },
        {
          question: "Вычислите интеграл $\\int x e^{-x^2} dx$",
          options: [
            "$-\\tfrac{1}{2} e^{-x^2} + C$",
            "$\\tfrac{1}{2} e^{-x^2} + C$",
            "$-e^{-x^2} + C$",
        ...
        {
          question: "Вычислите интеграл $\\int \\ln^2(x) dx$",
          options: [
            "$x(\\ln^2(x) + 2 \\ln(x) - 2) + C$",
            "$x \\ln^2(x) - x + C$",
            "$x(\\ln^2(x) - 2 \\ln(x) + 2) + C$",
        ...
        {
          question: "Вычислите интеграл $\\int \\cos^3(x) dx$",
          options: [
            "$\\sin(x) - \\tfrac{1}{3} \\sin^3(x) + C$",
            "$\\tfrac{1}{3} \\sin^3(x) + C$",
            "$\\tfrac{1}{4} \\sin(2x) + C$",
            "$\\sin(x) - \\tfrac{1}{4} \\sin(2x) + C$",
          ],
          correct: 0,
        },
        [
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{x^2 + 1}{x^4 + 1}  dx$$",
            options: [
          ...
          {
            question: "Вычислите интеграл: $$\\int \\frac{dx}{x(x^n + a^n)}$$",
            options: [
              "$$\\frac{1}{a^n} \\ln \\left| \\frac{x}{x^n + a^n} \\right| + C$$",
              "$$\\frac{1}{na^n} \\ln \\left| \\frac{x^n}{x^n + a^n} \\right| + C$$",
              "$$\\frac{1}{n} \\ln \\left| \\frac{x^n + a^n}{x^n} \\right| + C$$",
              "$$\\frac{1}{na^n} \\ln |x| - \\frac{1}{n} \\ln |x^n + a^n| + C$$",
            ],
            correct: 1,
          },
          {
            question: "Вычислите интеграл: $$\\int \\sqrt{\\tan x}  dx$$",
            options: [
              "$$\\frac{1}{2\\sqrt{2}} \\ln \\left| \\frac{\\tan x - \\sqrt{2\\tan x} + 1}{\\tan x + \\sqrt{2\\tan x} + 1} \\right| + \\frac{1}{\\sqrt{2}} \\arctan\\left(\\frac{\\sqrt{2\\tan x}}{1 - \\tan x}\\right) + C$$",
              "$$\\frac{1}{2} \\ln |\\sin x - \\cos x| + \\frac{1}{\\sqrt{2}} \\arctanh\\left(\\frac{\\sin x + \\cos x}{\\sqrt{2}}\\right) + C$$",
              "$$2\\sqrt{\\tan x} - 2\\sqrt{\\cot x} + C$$",
              "$$\\frac{2}{3}(\\tan x)^{3/2} - 2(\\tan x)^{1/2} + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{\\sin^4 x + \\cos^4 x}$$",
            options: [
              "$$\\frac{1}{\\sqrt{2}} \\arctan\\left(\\frac{\\sin 2x}{\\sqrt{2}}\\right) + C$$",
              "$$\\frac{1}{2} \\ln |\\tan x| + \\frac{1}{4} \\sin 2x + C$$",
              "$$\\frac{1}{2\\sqrt{2}} \\ln \\left| \\frac{\\sqrt{2} - \\sin 2x}{\\sqrt{2} + \\sin 2x} \\right| + C$$",
              "$$\\frac{x}{2} + \\frac{1}{8} \\sin 4x + C$$",
            ],
            correct: 2,
          },
          {
            question: "Вычислите интеграл: $$\\int x^2 \\sqrt{x^2 + a^2}  dx$$",
            options: [
              "$$\\frac{x}{4} (x^2 + a^2)^{3/2} - \\frac{a^2}{8} x \\sqrt{x^2 + a^2} + \\frac{a^4}{8} \\ln |x + \\sqrt{x^2 + a^2}| + C$$",
              "$$\\frac{x}{8} (2x^2 + a^2) \\sqrt{x^2 + a^2} - \\frac{a^4}{8} \\ln |x + \\sqrt{x^2 + a^2}| + C$$",
              "$$\\frac{1}{4} x (x^2 + a^2)^{3/2} + \\frac{3a^2}{8} x \\sqrt{x^2 + a^2} + \\frac{3a^4}{8} \\ln |x + \\sqrt{x^2 + a^2}| + C$$",
              "$$\\frac{1}{3} x (x^2 + a^2)^{3/2} - \\frac{2}{15} (x^2 + a^2)^{5/2} + C$$",
            ],
            correct: 1,
          },
          {
            question: "Вычислите интеграл: $$\\int \\frac{dx}{x^4 + 4}$$",
            options: [
              "$$\\frac{1}{16} \\ln \\left| \\frac{x^2 + 2x + 2}{x^2 - 2x + 2} \\right| + \\frac{1}{8} \\arctan(x + 1) + \\frac{1}{8} \\arctan(x - 1) + C$$",
              "$$\\frac{1}{16} \\ln \\left| \\frac{x^2 + 2x + 2}{x^2 - 2x + 2} \\right| + \\frac{1}{8} \\arctan\\left(\\frac{x^2 - 2}{2x}\\right) + C$$",
              "$$\\frac{1}{8} \\ln |x^2 + 2| - \\frac{1}{8} \\ln |x^2 - 2| + C$$",
              "$$\\frac{1}{4} \\arctan\\left(\\frac{x^2}{2}\\right) + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\sqrt{x^2 + 1}}{x}  dx$$",
            options: [
              "$$\\sqrt{x^2 + 1} - \\ln \\left| \\frac{1 + \\sqrt{x^2 + 1}}{x} \\right| + C$$",
              "$$\\sqrt{x^2 + 1} + \\frac{1}{2} \\ln |x| + C$$",
              "$$\\frac{1}{2} x \\sqrt{x^2 + 1} + \\frac{1}{2} \\ln |x + \\sqrt{x^2 + 1}| + C$$",
              "$$\\sqrt{x^2 + 1} + \\arctan \\left( \\frac{1}{\\sqrt{x^2 + 1}} \\right) + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{x \\sqrt{x^2 - x + 1}}$$",
            options: [
              "$$\\ln \\left| \\frac{2\\sqrt{x^2 - x + 1} + 2x - 1}{2x} \\right| + C$$",
              "$$\\frac{1}{2} \\ln |x| - \\frac{1}{4} \\ln |x^2 - x + 1| + C$$",
              "$$\\arctan\\left( \\frac{2x - 1}{2\\sqrt{x^2 - x + 1}} \\right) + C$$",
              "$$2 \\arcsin\\left( \\frac{2x - 1}{\\sqrt{3}} \\right) + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{\\sin x + \\tan x}$$",
            options: [
              "$$\\frac{1}{2} \\ln |1 - \\cos x| - \\frac{1}{4} (1 - \\cos x)^2 + C$$",
              "$$\\frac{1}{2} \\ln |\\csc x - \\cot x| + \\frac{1}{2} \\cos x + C$$",
              "$$-\\frac{1}{2} \\ln |1 + \\cos x| + \\frac{1}{4} \\cos^2 x + C$$",
              "$$\\frac{1}{2} \\ln |\\tan \\frac{x}{2}| - \\frac{1}{4} \\sin^2 x + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{x^2}{\\sqrt{1 - x^4}}  dx$$",
            options: [
              "$$\\frac{1}{2} \\ln |x^2 + \\sqrt{1 - x^4}| + C$$",
              "$$\\frac{1}{4} \\ln \\left| \\frac{1 + x^2}{1 - x^2} \\right| + C$$",
              "$$\\frac{1}{2} \\arcsin(x^2) + C$$",
              "$$\\frac{1}{2} \\arctanh(x^2) + C$$",
            ],
            correct: 2,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\ln(x + \\sqrt{1 + x^2})  dx$$",
            options: [
              "$$x \\ln(x + \\sqrt{1 + x^2}) - \\sqrt{1 + x^2} + C$$",
              "$$x \\ln(x + \\sqrt{1 + x^2}) + \\sqrt{1 + x^2} + C$$",
              "$$\\frac{1}{2} x^2 \\ln(x + \\sqrt{1 + x^2}) - \\frac{1}{4} x \\sqrt{1 + x^2} + \\frac{1}{4} \\ln |x + \\sqrt{1 + x^2}| + C$$",
              "$$\\ln(x + \\sqrt{1 + x^2}) + \\frac{x}{\\sqrt{1 + x^2}} + C$$",
            ],
            correct: 0,
          },
          {
            question: "Вычислите интеграл: $$\\int \\frac{dx}{x^6 + 1}$$",
            options: [
              "$$\\frac{1}{6} \\ln |x^2 + 1| - \\frac{1}{12} \\ln |x^4 - x^2 + 1| + \\frac{1}{2\\sqrt{3}} \\arctan\\left(\\frac{2x^2 - 1}{\\sqrt{3}}\\right) + C$$",
              "$$\\frac{1}{6} \\sum_{k=0}^{5} \\ln |x - e^{i(\\pi/6 + k\\pi/3)}| + C$$",
              "$$\\frac{1}{3} \\arctan(x^3) + C$$",
              "$$\\frac{1}{6} \\ln \\left| \\frac{x^2 + \\sqrt{3}x + 1}{x^2 - \\sqrt{3}x + 1} \\right| + \\frac{1}{2\\sqrt{3}} \\arctan\\left(\\frac{2x^2}{\\sqrt{3}}\\right) + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\sin^2 x}{\\sin^4 x + \\cos^4 x}  dx$$",
            options: [
              "$$\\frac{1}{2} x - \\frac{1}{4\\sqrt{2}} \\ln |\\cos 2x| + C$$",
              "$$\\frac{1}{4} \\ln |\\tan x| + \\frac{1}{8} \\cos 2x + C$$",
              "$$\\frac{1}{2} \\arctan(\\sqrt{2} \\tan x) - \\frac{1}{4\\sqrt{2}} \\ln \\left| \\frac{\\sqrt{2} - \\sin 2x}{\\sqrt{2} + \\sin 2x} \\right| + C$$",
          ...
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{\\sqrt[3]{(x+1)^2 (x-1)^4}}$$",
            options: [
              "$$-3 \\sqrt[3]{\\frac{x+1}{x-1}} + C$$",
              "$$3 \\sqrt[3]{\\frac{x-1}{x+1}} + C$$",
              "$$\\frac{3}{2} \\sqrt[3]{(x-1)^2 (x+1)} + C$$",
              "$$\\frac{3}{4} ((x-1)(x+1)^2)^{1/3} + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{x^3}{\\sqrt{1 + x^8}}  dx$$",
            options: [
              "$$\\frac{1}{4} \\sinh^{-1}(x^4) + C$$",
              "$$\\frac{1}{4} \\ln |x^4 + \\sqrt{1 + x^8}| + C$$",
              "$$\\frac{1}{8} (x^4 \\sqrt{1 + x^8} + \\ln |x^4 + \\sqrt{1 + x^8}|) + C$$",
              "$$\\frac{1}{2} \\arctan(x^4) + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int e^x \\frac{1 - \\sin x}{1 - \\cos x}  dx$$",
            options: [
              "$$-e^x \\cot \\frac{x}{2} + C$$",
              "$$e^x \\tan \\frac{x}{2} + C$$",
              "$$e^x \\frac{\\sin x}{1 - \\cos x} + C$$",
              "$$-e^x \\frac{1 + \\sin x}{1 - \\cos x} + C$$",
            ],
            correct: 0,
          },
          {
            question: "Вычислите интеграл: $$\\int \\frac{dx}{(x^2 + 4)^2}$$",
            options: [
              "$$\\frac{x}{8(x^2 + 4)} + \\frac{1}{16} \\arctan\\left(\\frac{x}{2}\\right) + C$$",
              "$$\\frac{x}{4(x^2 + 4)} + \\frac{1}{8} \\arctan\\left(\\frac{x}{2}\\right) + C$$",
              "$$-\\frac{x}{4(x^2 + 4)} + \\frac{1}{4} \\ln |x^2 + 4| + C$$",
              "$$\\frac{1}{2(x^2 + 4)} + \\frac{1}{4} \\arctan\\left(\\frac{x}{2}\\right) + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\sqrt{\\frac{1 - x}{1 + x}}  dx$$",
            options: [
              "$$\\arcsin x + \\sqrt{1 - x^2} + C$$",
              "$$\\arccos x - \\sqrt{1 - x^2} + C$$",
              "$$\\sqrt{1 - x^2} - \\arccos x + C$$",
              "$$\\arctan\\left(\\sqrt{\\frac{1 - x}{1 + x}}\\right) + \\sqrt{1 - x^2} + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\ln(1 + x^2)}{x^2}  dx$$",
            options: [
              "$$-\\frac{\\ln(1 + x^2)}{x} + \\ln \\left| \\frac{x}{1 + x^2} \\right| + C$$",
              "$$-\\frac{\\ln(1 + x^2)}{x} + 2 \\arctan x + C$$",
              "$$\\frac{\\ln(1 + x^2)}{x} - 2x + 2 \\arctan x + C$$",
              "$$-\\frac{\\ln(1 + x^2)}{x} - 2 \\arctan x + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{x^5}{\\sqrt{1 + x^{12}}}  dx$$",
            options: [
              "$$\\frac{1}{6} \\sinh^{-1}(x^6) + C$$",
              "$$\\frac{1}{12} (x^6 \\sqrt{1 + x^{12}} + \\ln |x^6 + \\sqrt{1 + x^{12}}|) + C$$",
              "$$\\frac{1}{6} \\ln |x^6 + \\sqrt{1 + x^{12}}| + C$$",
              "$$\\frac{1}{3} \\arctan(x^6) + C$$",
            ],
            correct: 2,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{x^3\\sqrt{x^2 - 1}}$$",
            options: [
              "$$\\frac{\\sqrt{x^2-1}}{2x^2} + \\frac{1}{2} \\ln \\left| \\frac{1+\\sqrt{x^2-1}}{x} \\right| + C$$",
              "$$\\frac{\\sqrt{x^2-1}}{2x^2} - \\frac{1}{2} \\sec^{-1}x + C$$",
              "$$\\frac{\\sqrt{x^2-1}}{x^2} + \\ln |x + \\sqrt{x^2-1}| + C$$",
              "$$-\\frac{\\sqrt{x^2-1}}{2x^2} + \\frac{1}{2} \\cosh^{-1}x + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\arctan x}{x^2}  dx$$",
            options: [
              "$$-\\frac{\\arctan x}{x} + \\frac{1}{2} \\ln \\left| \\frac{x^2}{1+x^2} \\right| + C$$",
              "$$-\\frac{\\arctan x}{x} - \\frac{1}{2} \\ln \\left| \\frac{1+x^2}{x^2} \\right| + C$$",
              "$$\\frac{\\arctan x}{x} + \\frac{1}{2} \\ln |1+x^2| + C$$",
          ...
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{\\sqrt{x} + \\sqrt[4]{x}}$$",
            options: [
              "$$2\\sqrt{x} - 4\\sqrt[4]{x} + 4\\ln|1+\\sqrt[4]{x}| + C$$",
              "$$4\\sqrt[4]{x} - 4\\ln|1+\\sqrt[4]{x}| + C$$",
              "$$2\\sqrt{x} - 4\\sqrt[4]{x} + 4\\arctan(\\sqrt[4]{x}) + C$$",
              "$$\\sqrt{x} - 2\\sqrt[4]{x} + 2\\ln|1+\\sqrt[4]{x}| + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{x^2}{\\sqrt{x^6 + 4}}  dx$$",
            options: [
              "$$\\frac{1}{3} \\ln |x^3 + \\sqrt{x^6+4}| + C$$",
              "$$\\frac{1}{3} \\sinh^{-1}\\left(\\frac{x^3}{2}\\right) + C$$",
              "$$\\frac{1}{6} \\ln |x^3 + \\sqrt{x^6+4}| + C$$",
              "$$\\frac{1}{2} \\arctan\\left(\\frac{x^3}{2}\\right) + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\sin x}{\\sin^3 x + \\cos^3 x}  dx$$",
            options: [
              "$$\\frac{1}{6} \\ln \\left| \\frac{1+\\sin x}{1-\\sin x} \\right| - \\frac{1}{2\\sqrt{3}} \\arctan\\left(\\frac{2\\sin x-1}{\\sqrt{3}}\\right) + C$$",
              "$$\\frac{1}{2} \\ln |\\sin x + \\cos x| - \\frac{1}{2\\sqrt{3}} \\arctan\\left(\\frac{2\\tan x-1}{\\sqrt{3}}\\right) + C$$",
              "$$\\frac{1}{3} \\ln |1+\\tan x| - \\frac{1}{6} \\ln |1-\\tan x+\\tan^2 x| + C$$",
              "$$\\frac{1}{2} \\ln |\\sin x| - \\frac{1}{2} \\ln |\\cos x| + \\frac{1}{6} \\ln |\\sin^3 x + \\cos^3 x| + C$$",
            ],
            correct: 1,
          },
          {
            question: "Вычислите интеграл: $$\\int \\frac{dx}{x(x^3+1)}$$",
            options: [
              "$$\\ln |x| - \\frac{1}{3} \\ln |x^3+1| + C$$",
              "$$\\frac{1}{3} \\ln \\left| \\frac{x^3}{x^3+1} \\right| + C$$",
              "$$\\ln |x| - \\frac{1}{6} \\ln (x^2-x+1) - \\frac{1}{\\sqrt{3}} \\arctan\\left(\\frac{2x-1}{\\sqrt{3}}\\right) + C$$",
              "$$\\frac{1}{3} \\ln |x| - \\frac{1}{6} \\ln (x^2+x+1) + \\frac{1}{\\sqrt{3}} \\arctan\\left(\\frac{2x+1}{\\sqrt{3}}\\right) + C$$",
            ],
            correct: 2,
          },
          {
            ...
            options: [
              ...
              "$$-\\sqrt{1-x^2} + \\arccos x + C$$",
              "$$\\sqrt{1-x^2} + \\ln \\left| \\frac{1+\\sqrt{1-x^2}}{x} \\right| + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{x^2}{\\sqrt{1-x^4}}  dx$$",
            options: [
              "$$\\frac{1}{2} \\sin^{-1}(x^2) - \\frac{1}{4} x\\sqrt{1-x^4} + C$$",
              "$$\\frac{1}{4} \\arcsin(x^2) + \\frac{1}{4} x\\sqrt{1-x^4} + C$$",
              "$$\\frac{1}{2} \\ln |x^2 + \\sqrt{1-x^4}| + C$$",
              "$$\\frac{1}{2} \\arcsin(x^2) + C$$",
            ],
            correct: 3,
          ...
          {
            question: "Вычислите интеграл: $$\\int \\frac{e^x}{1+e^{2x}}  dx$$",
            options: [
              "$$\\arctan(e^x) + C$$",
              "$$\\ln |1+e^{2x}| + C$$",
              "$$\\frac{1}{2} \\ln \\left| \\frac{e^x-1}{e^x+1} \\right| + C$$",
          ...
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{x\\sqrt{x^2+x+1}}$$",
            options: [
              "$$-\\frac{1}{2} \\ln \\left| \\frac{2\\sqrt{x^2+x+1}+2x+1}{2x} \\right| + C$$",
              "$$\\ln \\left| \\frac{2\\sqrt{x^2+x+1}+2x+1}{x} \\right| + C$$",
              "$$-\\frac{2}{\\sqrt{3}} \\arctan\\left(\\frac{2x+1}{\\sqrt{3}\\sqrt{x^2+x+1}}\\right) + C$$",
              "$$\\frac{1}{2} \\ln |x| - \\frac{1}{4} \\ln |x^2+x+1| + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\cos 2x}{\\sin^4 x + \\cos^4 x}  dx$$",
            options: [
              "$$\\frac{1}{\\sqrt{2}} \\arctan(\\sqrt{2} \\tan x) + C$$",
              "$$\\frac{1}{2} \\ln \\left| \\frac{1+\\sin 2x}{1-\\sin 2x} \\right| + C$$",
              "$$\\frac{1}{2} \\arctan(\\tan^2 x) + C$$",
              "$$\\frac{1}{2\\sqrt{2}} \\ln \\left| \\frac{\\sqrt{2}+\\sin 2x}{\\sqrt{2}-\\sin 2x} \\right| + C$$",
            ],
            correct: 3,
          ...
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{\\sqrt{x}(1+\\sqrt[4]{x})}$$",
            options: [
              "$$4\\sqrt[4]{x} - 4\\ln|1+\\sqrt[4]{x}| + C$$",
              "$$2\\sqrt{x} - 4\\sqrt[4]{x} + 4\\ln|1+\\sqrt[4]{x}| + C$$",
              "$$4\\sqrt[4]{x} - 4\\arctan(\\sqrt[4]{x}) + C$$",
          ...
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{x^3}{\\sqrt{1+x^2}}  dx$$",
            options: [
              "$$\\frac{1}{3}(1+x^2)^{3/2} - \\sqrt{1+x^2} + C$$",
              "$$\\frac{1}{3}x^2\\sqrt{1+x^2} - \\frac{2}{3}\\sqrt{1+x^2} + C$$",
              "$$\\frac{1}{3}(x^2-2)\\sqrt{1+x^2} + C$$",
              "$$\\frac{1}{2}x^2\\sqrt{1+x^2} - \\frac{1}{2}\\ln|x+\\sqrt{1+x^2}| + C$$",
            ],
            correct: 2,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\sin^2 x}{\\sin x + \\cos x}  dx$$",
            options: [
              "$$\\frac{1}{2} (\\sin x + \\cos x) + \\frac{1}{2} \\ln |\\sin x + \\cos x| + C$$",
              "$$\\frac{1}{2} x - \\frac{1}{4} \\cos 2x + \\frac{1}{2} \\ln |\\sin x + \\cos x| + C$$",
              "$$\\frac{1}{2} (\\sin x - \\cos x) + \\frac{1}{2\\sqrt{2}} \\ln \\left| \\frac{\\sin x - \\cos x + \\sqrt{2}}{\\sin x - \\cos x - \\sqrt{2}} \\right| + C$$",
              "$$\\frac{1}{2} (\\sin x - \\cos x) + \\frac{1}{2} \\arctan(\\sin x - \\cos x) + C$$",
            ],
            correct: 2,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{x^2\\sqrt{x^2+9}}$$",
            options: [
              "$$-\\frac{\\sqrt{x^2+9}}{9x} + \\frac{1}{3} \\ln \\left| \\frac{3+\\sqrt{x^2+9}}{x} \\right| + C$$",
              "$$-\\frac{\\sqrt{x^2+9}}{9x} + \\frac{1}{9} \\sinh^{-1}\\left(\\frac{x}{3}\\right) + C$$",
              "$$\\frac{\\sqrt{x^2+9}}{9x} - \\frac{1}{9} \\ln |x+\\sqrt{x^2+9}| + C$$",
              "$$-\\frac{\\sqrt{x^2+9}}{9x} + C$$",
            ],
            correct: 3,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\arctan \\sqrt{x}}{\\sqrt{x}(1+x)}  dx$$",
            options: [
              "$$(\\arctan \\sqrt{x})^2 + C$$",
              "$$\\frac{1}{2} (\\arctan \\sqrt{x})^2 + C$$",
              "$$\\ln |1+x| \\arctan \\sqrt{x} + C$$",
              "$$\\frac{1}{2} \\ln |1+x| + (\\arctan \\sqrt{x})^2 + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{\\sin x \\sqrt{\\sin 2x}}$$",
            options: [
              "$$-\\sqrt{2} \\ln |\\csc x + \\cot x| + C$$",
              "$$-\\sqrt{2} \\ln |\\csc x - \\cot x + \\sqrt{2} \\cot x| + C$$",
              "$$\\sqrt{2} \\ln |\\tan x + \\sqrt{\\tan^2 x + 1}| + C$$",
              "$$-\\frac{1}{\\sqrt{2}} \\ln |\\csc x + \\cot x| + C$$",
            ],
            correct: 1,
          },
          {
            question: "Вычислите интеграл: $$\\int \\frac{x^2+1}{x^4+1}  dx$$",
            options: [
              "$$\\frac{1}{\\sqrt{2}} \\arctan\\left(\\frac{x^2-1}{\\sqrt{2}x}\\right) + C$$",
              "$$\\frac{1}{2\\sqrt{2}} \\ln \\left| \\frac{x^2-\\sqrt{2}x+1}{x^2+\\sqrt{2}x+1} \\right| + C$$",
              "$$\\frac{1}{\\sqrt{2}} \\tanh^{-1}\\left(\\frac{\\sqrt{2}x}{x^2+1}\\right) + C$$",
              "$$\\frac{1}{2} \\ln \\left| \\frac{x^2+1}{x^2-1} \\right| + C$$",
            ],
            correct: 1,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{dx}{x\\sqrt{x^2-4x+3}}$$",
            options: [
              "$$-\\frac{1}{\\sqrt{3}} \\ln \\left| \\frac{\\sqrt{x^2-4x+3}+x-2}{x} \\right| + C$$",
              "$$\\ln \\left| \\frac{x-2+\\sqrt{x^2-4x+3}}{x} \\right| + C$$",
              "$$\\frac{1}{2} \\ln |x| - \\frac{1}{2} \\ln |x^2-4x+3| + C$$",
              "$$\\arcsin\\left(\\frac{x-2}{\\sqrt{3}}\\right) + C$$",
            ],
            correct: 0,
          },
          {
            question:
              "Вычислите интеграл: $$\\int \\frac{\\sin^3 x}{\\cos^4 x}  dx$$",
            options: [
 ...
 console.log("Very hard integrals questions count:", veryHardIntegralsQuestions.length);
=======
        ],
        correct: 3
    },
