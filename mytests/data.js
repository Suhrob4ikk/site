...
const mathQuestions = {
  derivatives: {
    easy: [
      ...
      {
        question:
          "Найдите производную функции \\( f(x) = 3x^4 - 2x^3 + 5x - 7 \\)",
        answers: [
    ...
    hard: [
      ...
      {
        question:
          "Найдите вторую производную функции \\( f(x) = \\ln(x^2 + 1) \\)",
        answers: [
      ...
      {
        question:
          "Найдите производную функции \\( f(x) = \\int_0^x e^{-t^2} dt \\)",
        answers: [
      ...
      {
        question:
          "Найдите производную функции, заданной параметрически: \\( x = \\cos(t), y = \\sin(t) \\)",
        answers: [
      ...
      {
        question:
          "Найдите производную функции \\( f(x) = \\arcsin(\\sqrt{x}) \\)",
        answers: [
      ...
      },
      {
        ...
        answers: [
          {
            text: "\\( x^{\\sin(x)} \\left( \\frac{\\sin(x)}{x} + \\cos(x) \\ln(x) \\right) \\)",
            correct: true,
          },
          {
            text: "\\( x^{\\sin(x)} \\left( \\frac{\\sin(x)}{x} + \\cos(x) \\right) \\)",
            correct: false,
          },
          {
            text: "\\( x^{\\sin(x)} \\left( \\cos(x) \\ln(x) \\right) \\)",
            correct: false,
          },
      ...
      {
        question:
          "Найдите производную функции \\( f(x) = \\frac{1}{\\sqrt{2\\pi}} e^{-\\frac{x^2}{2}} \\)",
        answers: [
          {
            text: "\\( -\\frac{x}{\\sqrt{2\\pi}} e^{-\\frac{x^2}{2}} \\)",
            correct: true,
          },
          {
            text: "\\( -\\frac{x^2}{\\sqrt{2\\pi}} e^{-\\frac{x^2}{2}} \\)",
            correct: false,
          },
          {
            text: "\\( \\frac{x}{\\sqrt{2\\pi}} e^{-\\frac{x^2}{2}} \\)",
          ...
          {
            text: "\\( -\\frac{1}{\\sqrt{2\\pi}} e^{-\\frac{x^2}{2}} \\)",
            correct: false,
          },
        ],
      },
      {
        question:
          "Найдите производную функции \\( f(x) = \\text{arccosh}(x) = \\ln(x + \\sqrt{x^2 - 1}) \\)",
        answers: [
      ...
      {
        question:
          "Найдите производную функции \\( f(x) = \\int_{x}^{x^2} e^{-t^2} dt \\)",
        answers: [
      ...
      {
        question:
          "Найдите производную функции \\( f(x) = \\ln\\left( \\frac{\\sqrt{x} + 1}{\\sqrt{x} - 1} \\right) \\)",
        answers: [
  ...
  integrals: {
    easy: [
      ...
      {
        question:
          "Чему равен интеграл \\( \\int a^x dx \\) где \\( a > 0, a \\neq 1 \\)?",
        answers: [
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\frac{1}{\\sqrt{1-x^2}} dx \\)?",
        answers: [
    ...
    medium: [
      ...
      {
        question: "Чему равен интеграл \\( \\int (3x^2 - 4x + 1)\\,dx \\)?",
        answers: [
          { text: "\\( x^3 - 2x^2 + x + C \\)", correct: true },
          { text: "\\( 3x^3 - 4x^2 + x + C \\)", correct: false },
          { text: "\\( x^3 - 4x^2 + x + C \\)", correct: false },
          { text: "\\( x^3 - 2x^2 + 2x + C \\)", correct: false },
        ],
      },

      {
        question:
          "Чему равен интеграл \\( \\int \\frac{2x+3}{x^2+3x+2}\\,dx \\)?",
        answers: [
          { text: "\\( \\ln|x+1| + \\ln|x+2| + C \\)", correct: true },
          { text: "\\( \\tfrac{1}{2}\\ln(x^2+3x+2) + C \\)", correct: false },
          { text: "\\( \\arctan(x) + C \\)", correct: false },
          { text: "\\( \\frac{1}{x^2+3x+2} + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int x e^{x}\\,dx \\)?",
        answers: [
          { text: "\\( e^{x}(x-1) + C \\)", correct: true },
          { text: "\\( e^{x}(x+1) + C \\)", correct: false },
          { text: "\\( x e^{x} + C \\)", correct: false },
      ...
      {
        question: "Чему равен интеграл \\( \\int \\sin^3(x)\\cos(x)\\,dx \\)?",
        answers: [
          { text: "\\( \\tfrac{1}{4}\\sin^4(x) + C \\)", correct: true },
          { text: "\\( \\tfrac{1}{3}\\sin^3(x) + C \\)", correct: false },
          { text: "\\( -\\tfrac{1}{4}\\cos^4(x) + C \\)", correct: false },
          { text: "\\( \\tfrac{1}{2}\\sin^2(x) + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int \\frac{dx}{x^2+4} \\)?",
        answers: [
          {
            text: "\\( \\tfrac{1}{2}\\arctan\\frac{x}{2} + C \\)",
            correct: true,
          },
          { text: "\\( \\arctan(2x) + C \\)", correct: false },
          { text: "\\( \\tfrac{1}{4}\\arctan x + C \\)", correct: false },
          { text: "\\( \\ln(x^2+4) + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int x\\ln x\\,dx \\)?",
        answers: [
          {
            text: "\\( \\tfrac{x^2}{2}\\ln x - \\tfrac{x^2}{4} + C \\)",
            correct: true,
          },
          {
            text: "\\( \\tfrac{x^2}{2}\\ln x + \\tfrac{x^2}{4} + C \\)",
          ...
          { text: "\\( x^2\\ln x - x^2 + C \\)", correct: false },
          { text: "\\( \\ln^2 x + C \\)", correct: false },
        ],
      },

      {
        question:
          "Чему равен интеграл \\( \\int \\frac{x^2}{(x+1)^2}\\,dx \\)?",
        answers: [
          {
            text: "\\( x+1 - 2\\ln|x+1| - \\frac{1}{x+1} + C \\)",
            correct: true,
          },
          { text: "\\( \\frac{x^3}{3(x+1)^2} + C \\)", correct: false },
          { text: "\\( \\ln\\frac{x+1}{x} + C \\)", correct: false },
          { text: "\\( \\frac{x^2}{x+1} + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int e^{2x}\\cos(3x)\\,dx \\)?",
        answers: [
          {
            text: "\\( \\frac{e^{2x}}{13}\\bigl(2\\cos(3x)+3\\sin(3x)\\bigr) + C \\)",
            correct: true,
          },
          {
            text: "\\( \\frac{e^{2x}}{13}\\bigl(3\\cos(3x)-2\\sin(3x)\\bigr) + C \\)",
            correct: false,
          },
          {
            text: "\\( e^{2x}\\bigl(\\cos(3x)+\\sin(3x)\\bigr)+C \\)",
            correct: false,
          },
          {
            text: "\\( \\frac{e^{2x}}{5}\\bigl(2\\cos(3x)-3\\sin(3x)\\bigr)+C \\)",
            correct: false,
          },
        ],
      },
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\frac{dx}{\\sqrt{9-x^2}} \\)?",
        answers: [
          { text: "\\( \\arcsin\\frac{x}{3} + C \\)", correct: true },
          { text: "\\( \\arctan\\frac{x}{3} + C \\)", correct: false },
          { text: "\\( \\ln|3+x| + C \\)", correct: false },
          { text: "\\( -\\arccos\\frac{x}{3} + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int \\tan^2(x)\\,dx \\)?",
        answers: [
          { text: "\\( \\tan x - x + C \\)", correct: true },
          { text: "\\( \\tan x + x + C \\)", correct: false },
          { text: "\\( -\\cot x + C \\)", correct: false },
          { text: "\\( \\ln|\\cos x| + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int (x^3 - 2x + 5)\\,dx \\)?",
        answers: [
          { text: "\\( \\tfrac{x^4}{4} - x^2 + 5x + C \\)", correct: true },
          { text: "\\( \\tfrac{x^4}{3} - x^2 + 5x + C \\)", correct: false },
          { text: "\\( x^4 - 2x^2 + 5x + C \\)", correct: false },
          { text: "\\( x^3 - x^2 + 5x + C \\)", correct: false },
        ],
      },

      {
        ...
        answers: [
          {
            text: "\\( \\tfrac{1}{4}\\ln\\left|\\frac{x-2}{x+2}\\right| + C \\)",
            correct: true,
          },
          { text: "\\( \\tfrac{1}{2}\\ln|x^2-4| + C \\)", correct: false },
          { text: "\\( \\arctan\\frac{x}{2} + C \\)", correct: false },
          { text: "\\( \\frac{1}{x^2-4} + C \\)", correct: false },
        ],
      },

      {
        ...
        answers: [
          ...
          { text: "\\( e^{x}x^2 + C \\)", correct: false },
          { text: "\\( e^{x}(x^2 - x + 1) + C \\)", correct: false },
        ],
      },
      ...
      {
        question: "Чему равен интеграл \\( \\int \\frac{3x+2}{x^2+1}\\,dx \\)?",
        answers: [
          {
            text: "\\( \\tfrac{3}{2}\\ln(1+x^2) + 2\\arctan x + C \\)",
            correct: true,
          },
          { text: "\\( \\ln(1+x^2) + 2\\arctan x + C \\)", correct: false },
          { text: "\\( 3\\ln(1+x^2) + C \\)", correct: false },
          { text: "\\( \\arctan x + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int (x^2+1)\\ln x\\,dx \\)?",
        answers: [
          {
            text: "\\( \\bigl(\\tfrac{x^3}{3}+x\\bigr)\\ln x - \\tfrac{x^3}{9} - x + C \\)",
            correct: true,
          },
          {
            text: "\\( \\bigl(\\tfrac{x^3}{3}+x\\bigr)\\ln x + \\tfrac{x^3}{9} + x + C \\)",
          ...
          { text: "\\( x^2\\ln x + C \\)", correct: false },
          { text: "\\( \\ln^2 x + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int \\frac{dx}{(x+2)(x+3)} \\)?",
        answers: [
          { text: "\\( \\ln|x+2| - \\ln|x+3| + C \\)", correct: true },
          { text: "\\( \\ln|x+2| + \\ln|x+3| + C \\)", correct: false },
          { text: "\\( \\arctan x + C \\)", correct: false },
          {
            text: "\\( \\frac{1}{x+2} - \\frac{1}{x+3} + C \\)",
            correct: false,
          },
        ],
      },
      ...
      {
        question: "Чему равен интеграл \\( \\int e^{x}\\cosh x\\,dx \\)?",
        answers: [
          {
            text: "\\( \\tfrac{1}{4}e^{2x} + \\tfrac{x}{2} + C \\)",
            correct: true,
          },
          { text: "\\( e^{x}\\sinh x + C \\)", correct: false },
          { text: "\\( \\tfrac{1}{2}e^{2x} + C \\)", correct: false },
          { text: "\\( e^{x}\\cosh x + C \\)", correct: false },
        ],
      },

      {
        question:
          "Чему равен интеграл \\( \\int \\frac{\\cos x}{1+\\sin x}\\,dx \\)?",
        answers: [
          { text: "\\( \\ln|1+\\sin x| + C \\)", correct: true },
          { text: "\\( -\\ln|1+\\sin x| + C \\)", correct: false },
          { text: "\\( \\arctan(\\sin x) + C \\)", correct: false },
          { text: "\\( \\tan\\frac{x}{2} + C \\)", correct: false },
        ],
      },

      {
        question:
          "Чему равен интеграл \\( \\int \\frac{dx}{x\\sqrt{x^2-1}} \\)?",
        answers: [
          {
            text: "\\( \\arccos\\frac{1}{x} + C \\) (для \\(|x|>1\\))",
            correct: true,
          },
          { text: "\\( \\arcsin\\frac{1}{x} + C \\)", correct: false },
          { text: "\\( \\ln|x+\\sqrt{x^2-1}| + C \\)", correct: false },
          { text: "\\( \\sqrt{x^2-1} + C \\)", correct: false },
        ],
      },
    ],
    hard: [
      ...
      },
      {
        ...
        answers: [
          {
            text: "\\( \\frac{x}{2} \\sqrt{1-x^2} + \\frac{1}{2} \\arcsin(x) + C \\)",
            correct: true,
          },
      ...
      },
      {
        ...
        answers: [
          {
            text: "\\( \\frac{1}{3} \\ln|x+1| - \\frac{1}{6} \\ln|x^2 - x + 1| + \\frac{1}{\\sqrt{3}} \\arctan\\left(\\frac{2x-1}{\\sqrt{3}}\\right) + C \\)",
            correct: true,
          },
          { text: "\\( \\ln|x^3+1| + C \\)", correct: false },
          { text: "\\( \\frac{1}{3} \\ln|x^3+1| + C \\)", correct: false },
          {
            text: "\\( \\frac{1}{3} \\ln|x+1| + \\frac{2}{3} \\ln|x^2 - x + 1| + C \\)",
            correct: false,
          },
        ],
      },
      {
        ...
        answers: [
          {
            text: "\\( x \\ln(x^2+1) - 2x + 2 \\arctan(x) + C \\)",
            correct: true,
          },
      ...
      {
        question:
          "Найдите интеграл \\( \\int \\frac{x^2}{\\sqrt{1-x^2}} dx \\)",
        answers: [
          {
            text: "\\( \\frac{1}{2} \\arcsin(x) - \\frac{x}{2} \\sqrt{1-x^2} + C \\)",
            correct: true,
          },
          { text: "\\( -\\sqrt{1-x^2} + C \\)", correct: false },
      ...
      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{1} \\ln(1+x)\\,dx \\)?",
        answers: [
          { text: "\\( 2\\ln 2 - 1 \\)", correct: true },
          { text: "\\( \\ln 2 - \\tfrac{1}{2} \\)", correct: false },
          { text: "\\( \\tfrac{1}{2}\\ln 2 \\)", correct: false },
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\frac{\\ln x}{x^2+1}\\,dx \\)?",
        answers: [
          {
            text: "Не выражается элементарно (выражается через специальные функции, напр. ди-логарифмы), + C",
            correct: true,
          },
          { text: "\\( \\ln x\\cdot\\arctan x + C \\)", correct: false },
          { text: "\\( \\tfrac{1}{2}\\ln^2(1+x^2) + C \\)", correct: false },
          { text: "\\( \\arctan(\\ln x) + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int \\arctan x\\,dx \\)?",
        answers: [
          {
            text: "\\( x\\arctan x - \\tfrac{1}{2}\\ln(1+x^2) + C \\)",
            correct: true,
          },
          { text: "\\( \\arctan^2 x + C \\)", correct: false },
          { text: "\\( x^2\\arctan x + C \\)", correct: false },
          { text: "\\( \\ln(1+x^2) + C \\)", correct: false },
        ],
      },
      ...
      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{\\pi/2} \\ln(\\sin x)\\,dx \\)?",
        answers: [
          { text: "\\( -\\tfrac{\\pi}{2}\\ln 2 \\)", correct: true },
          { text: "\\( 0 \\)", correct: false },
          { text: "\\( -\\ln 2 \\)", correct: false },
          { text: "\\( \\tfrac{\\pi}{2}\\ln 2 \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int \\frac{dx}{x^4+1} \\)?",
        answers: [
          {
            text: "\\( \\tfrac{1}{2\\sqrt{2}}\\ln\\frac{x^2+\\sqrt{2}x+1}{x^2-\\sqrt{2}x+1} + \\tfrac{1}{\\sqrt{2}}\\arctan\\frac{\\sqrt{2}x}{1-x^2} + C \\)",
            correct: true,
          },
          { text: "\\( \\arctan x + C \\)", correct: false },
          { text: "\\( \\ln(x^4+1) + C \\)", correct: false },
          {
            text: "Не существует примитив в виде элементарных функций",
            correct: false,
          },
        ],
      },
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\sqrt{\\dfrac{1-x}{1+x}}\\,dx \\)?",
        answers: [
          {
            text: "Выражается через элементарные функции (содержит корень и логарифм), например через подстановку \\(x=\\cos 2t\\) + C",
            correct: true,
          },
          { text: "\\( \\arctan x + C \\)", correct: false },
          { text: "\\( e^{x} + C \\)", correct: false },
          { text: "Не выражается через элементарные функции", correct: false },
        ],
      },

      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{1} \\frac{\\arctan x}{x}\\,dx \\)?",
        answers: [
          {
            text: "Константа Каталана \\( G \\) (\\(G=\\sum_{n=0}^{\\infty} \\dfrac{(-1)^n}{(2n+1)^2}\\))",
            correct: true,
          },
          { text: "\\( \\tfrac{\\pi}{4}\\ln 2 \\)", correct: false },
          { text: "\\( \\tfrac{\\pi^2}{12} \\)", correct: false },
          { text: "Не сходится", correct: false },
        ],
      },

      {
        question:
          "Чему равен интеграл \\( \\int \\frac{\\sin x}{1+\\cos^2 x}\\,dx \\)?",
        answers: [
          { text: "\\( -\\arctan(\\cos x) + C \\)", correct: true },
          { text: "\\( \\arctan(\\cos x) + C \\)", correct: false },
          { text: "\\( \\ln(1+\\cos^2 x) + C \\)", correct: false },
          { text: "\\( \\tan^{-1}(\\sin x) + C \\)", correct: false },
        ],
      },

      {
        question: "Чему равен интеграл \\( \\int \\frac{x^3}{e^x-1}\\,dx \\)?",
        answers: [
          {
            text: "Не выражается элементарно (требует специальных функций / рядовых представлений), + C",
            correct: true,
          },
          { text: "\\( x^3\\ln(e^x-1) + C \\)", correct: false },
          { text: "\\( \\tfrac{x^4}{4(e^x-1)} + C \\)", correct: false },
          { text: "\\( e^x + C \\)", correct: false },
        ],
      },
      ...
      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{\\pi} \\frac{x\\sin x}{1+\\cos^2 x}\\,dx \\)?",
        answers: [
          { text: "\\( \\dfrac{\\pi^2}{4} \\)", correct: true },
          { text: "\\( \\dfrac{\\pi^2}{6} \\)", correct: false },
          { text: "\\( \\dfrac{\\pi}{2} \\)", correct: false },
          { text: "0", correct: false },
        ],
      },

      {
        question: "Чему равно \\( \\displaystyle \\int_{0}^{1} x^{x}\\,dx \\)?",
        answers: [
          {
            text: "Число (не выражается через элементарные функции), приблизительно \\(0.783430\\)",
            correct: true,
          },
          { text: "\\( 1 \\)", correct: false },
          { text: "\\( \\tfrac{1}{2} \\)", correct: false },
          { text: "Не существует (расходится)", correct: false },
        ],
      },

      {
        question:
          "Чему равен интеграл \\( \\int \\frac{\\ln(1+x)}{x}\\,dx \\)?",
        answers: [
          {
            text: "\\( -\\operatorname{Li}_2(-x) + C \\) (ди-логарифм)",
            correct: true,
          },
          { text: "\\( \\ln(1+x)\\ln x + C \\)", correct: false },
          { text: "\\( \\tfrac{1}{2}\\ln^2(1+x) + C \\)", correct: false },
          { text: "Не существует примитива", correct: false },
        ],
      },

      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{\\infty} \\frac{\\sin x}{x}\\,dx \\)?",
        answers: [
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\frac{dx}{\\sqrt{x^4+1}} \\)?",
        answers: [
          {
            text: "Не выражается элементарно (в общем даётся через эллиптические функции), + C",
            correct: true,
          },
          { text: "\\( \\ln(x^2+\\sqrt{x^4+1}) + C \\)", correct: false },
          { text: "\\( \\arctan x + C \\)", correct: false },
          { text: "\\( x\\sqrt{x^4+1} + C \\)", correct: false },
        ],
      },

      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{\\pi/4} \\ln(\\tan x)\\,dx \\)?",
        answers: [
          {
            text: "\\( -G \\) (отрицательная константа Каталана)",
            correct: true,
          },
          { text: "\\( -\\tfrac{\\pi}{4}\\ln 2 \\)", correct: false },
          { text: "\\( 0 \\)", correct: false },
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\dfrac{dx}{(1+x^2)\\sqrt{1-x^2}} \\)?",
        answers: [
          {
            text: "\\( \\dfrac{1}{\\sqrt{2}}\\arctan\\bigl(\\dfrac{\\tan(\\arcsin x)}{\\sqrt{2}}\\bigr) + C \\) (можно подставкой \\(x=\\sin t\\) упростить)",
            correct: true,
          },
          { text: "\\( \\arcsin x + C \\)", correct: false },
          {
            text: "\\( \\ln\\bigl|\\dfrac{1+x}{1-x}\\bigr| + C \\)",
            correct: false,
          },
          { text: "Не выражается через элементарные функции", correct: false },
        ],
      ...
      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{1} \\frac{\\ln(1-x)}{x}\\,dx \\)?",
        answers: [
          { text: "\\( -\\dfrac{\\pi^2}{6} \\)", correct: true },
          { text: "\\( -\\dfrac{\\pi^2}{12} \\)", correct: false },
          { text: "\\( 0 \\)", correct: false },
          { text: "\\( \\dfrac{\\pi^2}{6} \\)", correct: false },
        ],
      },
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\frac{\\arcsin x}{x}\\,dx \\)?",
        answers: [
          {
            text: "Не выражается элементарно (применимы специальные функции / ряды), + C",
            correct: true,
          },
          { text: "\\( \\arcsin(x)\\ln x + C \\)", correct: false },
          { text: "\\( \\tfrac{1}{2}\\arcsin^2 x + C \\)", correct: false },
          { text: "\\( \\ln(1+\\arcsin x) + C \\)", correct: false },
        ],
      },

      {
        question:
          "Чему равен интеграл \\( \\int \\dfrac{\\cos x}{1+e^{x}}\\,dx \\)?",
        answers: [
          {
            text: "Не выражается через простые элементарные функции в общем виде (требует сочетания экспонент и тригонометрии), + C",
            correct: true,
          },
      ...
      {
        question:
          "Чему равно \\( \\displaystyle \\int_{0}^{\\infty} \\frac{x}{e^{x}-1}\\,dx \\)?",
        answers: [
          {
            text: "\\( \\dfrac{\\pi^2}{6} \\) (\\;=\\zeta(2)\\;)",
            correct: true,
          },
          { text: "\\( \\dfrac{\\pi^2}{12} \\)", correct: false },
          { text: "Бесконечно", correct: false },
          { text: "0", correct: false },
        ],
      },
      {
        ...
        answers: [
          {
            text: "\\( \\frac{1}{2} (\\sec(x)\\tan(x) + \\ln|\\sec(x)+\\tan(x)|) + C \\)",
            correct: true,
          },
          { text: "\\( \\frac{1}{2} \\sec(x)\\tan(x) + C \\)", correct: false },
          {
            text: "\\( \\sec(x)\\tan(x) + \\ln|\\sec(x)+\\tan(x)| + C \\)",
            correct: false,
          },
      ...
      {
        question:
          "Чему равен интеграл \\( \\int \\frac{1}{x^2\\sqrt{x^2+1}} dx \\)?",
        answers: [
  ...
  series: {
    easy: [
      ...
      {
        question:
          "Является ли ряд \\( \\sum_{n=1}^{\\infty} \\frac{1}{n} \\) сходящимся?",
        answers: [
      ...
      {
        question:
          "Чему равна сумма геометрического ряда \\( \\sum_{n=0}^{\\infty} \\frac{1}{2^n} \\)?",
        answers: [
          { text: "2", correct: true },
          { text: "1", correct: false },
          { text: "∞", correct: false },
      ...
      {
        question:
          "Является ли ряд \\( \\sum_{n=1}^{\\infty} \\frac{1}{n^2} \\) сходящимся?",
        answers: [
      ...
      {
        question:
          "Чему равна сумма ряда \\( \\sum_{n=1}^{\\infty} \\frac{1}{n(n+1)} \\)?",
        answers: [
          { text: "1", correct: true },
          { text: "∞", correct: false },
          { text: "1/2", correct: false },
      ...
      {
        question:
          "Каким признаком удобно исследовать сходимость ряда \\( \\sum_{n=1}^{\\infty} \\frac{n}{2^n} \\)?",
        answers: [
      ...
      {
        question:
          "Является ли ряд \\( \\sum_{n=1}^{\\infty} (-1)^n \\frac{1}{n} \\) сходящимся?",
        answers: [
      ...
      {
        question:
          "Чему равен радиус сходимости степенного ряда \\( \\sum_{n=0}^{\\infty} x^n \\)?",
        answers: [
          { text: "1", correct: true },
          { text: "0", correct: false },
          { text: "∞", correct: false },
      ...
      {
        question:
          "Является ли ряд \\( \\sum_{n=1}^{\\infty} \\frac{1}{\\sqrt{n}} \\) сходящимся?",
        answers: [
          { text: "Расходится", correct: true },
          { text: "Сходится", correct: false },
          { text: "Сходится условно", correct: false },
      ...
      {
        question:
          "Чему равна сумма ряда \\( \\sum_{n=0}^{\\infty} \\frac{1}{3^n \\)?",
        answers: [
      ...
      {
        question:
          "Каким признаком удобно исследовать сходимость ряда \\( \\sum_{n=1}^{\\infty} \\frac{1}{n^p} \\)?",
        answers: [
    ...
    medium: [
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{n!}{10^n} \\)",
        answers: [
          { text: "Расходится", correct: true },
          { text: "Сходится", correct: false },
          { text: "Сходится условно", correct: false },
      ...
      {
        question:
          "Найдите радиус сходимости степенного ряда \\( \\sum_{n=0}^{\\infty} \\frac{x^n}{n!} \\)",
        answers: [
          { text: "∞", correct: true },
          { text: "1", correct: false },
          { text: "0", correct: false },
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{(-1)^n}{\\sqrt{n}} \\)",
        answers: [
          { text: "Сходится условно", correct: true },
          { text: "Сходится абсолютно", correct: false },
          { text: "Расходится", correct: false },
      ...
      {
        question:
          "Найдите сумму ряда \\( \\sum_{n=1}^{\\infty} \\frac{(-1)^{n+1}}{n} \\)",
        answers: [
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{n^2}{2^n} \\)",
        answers: [
          { text: "Сходится", correct: true },
          { text: "Расходится", correct: false },
          { text: "Сходится условно", correct: false },
      ...
      {
        question:
          "Найдите радиус сходимости степенного ряда \\( \\sum_{n=1}^{\\infty} \\frac{x^n}{n} \\)",
        answers: [
          { text: "1", correct: true },
          { text: "0", correct: false },
          { text: "∞", correct: false },
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{\\sin(n)}{n^2} \\)",
        answers: [
      ...
      {
        question:
          "Найдите сумму ряда \\( \\sum_{n=0}^{\\infty} \\frac{(-1)^n}{2n+1} \\)",
        answers: [
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{1}{n\\ln(n)} \\)",
        answers: [
          { text: "Расходится", correct: true },
          { text: "Сходится", correct: false },
          { text: "Сходится условно", correct: false },
      ...
      {
        question:
          "Найдите радиус сходимости степенного ряда \\( \\sum_{n=1}^{\\infty} n! x^n \\)",
        answers: [
          { text: "0", correct: true },
          { text: "1", correct: false },
          { text: "∞", correct: false },
    ...
    hard: [
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{(-1)^n}{n^p} \\) при p>1",
        answers: [
          { text: "Сходится абсолютно", correct: true },
          { text: "Сходится условно", correct: false },
          { text: "Расходится", correct: false },
      ...
      {
        question:
          "Найдите сумму ряда \\( \\sum_{n=1}^{\\infty} \\frac{n}{2^n} \\)",
        answers: [
          { text: "2", correct: true },
          { text: "1", correct: false },
          { text: "∞", correct: false },
      ...
      {
        question:
          "Найдите радиус сходимости степенного ряда \\( \\sum_{n=1}^{\\infty} \\frac{(x-2)^n}{n^2} \\)",
        answers: [
          { text: "1", correct: true },
          { text: "2", correct: false },
          { text: "∞", correct: false },
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{1}{n^{1+1/n}} \\)",
        answers: [
          { text: "Расходится", correct: true },
          { text: "Сходится", correct: false },
          { text: "Сходится условно", correct: false },
      ...
      {
        question:
          "Найдите сумму ряда \\( \\sum_{n=1}^{\\infty} \\frac{(-1)^{n+1}}{n^2} \\)",
        answers: [
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{\\cos(n)}{n} \\)",
        answers: [
          { text: "Расходится", correct: true },
          { text: "Сходится", correct: false },
          { text: "Сходится условно", correct: false },
      ...
      {
        question:
          "Найдите радиус сходимости степенного ряда \\( \\sum_{n=1}^{\\infty} \\frac{(2x)^n}{n^2} \\)",
        answers: [
      ...
      {
        question:
          "Исследуйте на сходимость ряд \\( \\sum_{n=1}^{\\infty} \\frac{(-1)^n n!}{n^n} \\)",
        answers: [
          { text: "Сходится абсолютно", correct: true },
          { text: "Сходится условно", correct: false },
          { text: "Расходится", correct: false },
...
const descriptions = {
  derivatives: {
    ...
    medium:
      "Производные сложных функций, неявное дифференцирование, логарифмическая производная",
  ...
  integrals: {
    ...
    medium:
      "Интегрирование по частям, заменой переменной, простые определенные интегралы",
